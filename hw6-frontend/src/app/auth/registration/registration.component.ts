...
export class RegistrationComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (valid && birthValid && passwordValid) {
        ...
        this.http.post('https://hw6server.herokuapp.com/register', data, { withCredentials: true }).subscribe(res => {
            if (res['result'] === 'success') {
              this.showSuccessMsg();
              this.http.post('https://hw6server.herokuapp.com/login', loginData, {withCredentials: true}).subscribe(re => {
